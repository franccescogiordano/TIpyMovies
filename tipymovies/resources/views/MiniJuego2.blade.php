    ...
    <body id="top" onload="next(0);">
            ...
            <div id="pageintro" class="hoc clear">
                <article>
                    <div>
                        ...
                        <img id="poster" src="{{$poster[0]}}">


                        <h2 id="pregunta" class="heading">pregunta</h2>

                        <div class="container">
                            <form id="formPreguntas" action="{{ route('Puntuar2') }}" method="POST">
                                @csrf
        ...
        <script>
            ...
            function next(respuesta){
                ...
                if(numPre<9){
                    numPre++;
                    var pster = document.getElementById("poster");
                    pster.src = pos[numPre];
